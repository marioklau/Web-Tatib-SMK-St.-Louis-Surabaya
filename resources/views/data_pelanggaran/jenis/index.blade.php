...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-start mb-8">Jenis Pelanggaran</h1>
        ...
        <table class="w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 text-left">Bentuk Pelanggaran</th>
            ...
            <tbody class="text-gray-700 text-sm font-light">
                @forelse ($jenis as $type)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-left">{{ $type->bentuk_pelanggaran }}</td>
                        <td class="py-3 px-6 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <!-- Tombol Edit -->
                                <a href="{{ route('jenis.edit', $type) }}" class="text-blue-600 hover:text-blue-800 transform hover:scale-110">
                                ...
                                <!-- Tombol Delete -->
                                <form action="{{ route('jenis.destroy', $type) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus bentuk pelanggaran ini?');">
                                    @csrf
                                    @method('DELETE')
