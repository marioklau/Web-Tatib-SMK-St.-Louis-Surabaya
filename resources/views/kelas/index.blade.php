                    ...
                    <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                        ...
                        <td class="p-1 whitespace-nowrap text-xs leading-6 font-medium text-gray-900">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <!-- Tombol Edit -->
                                <a href="{{ route('jenis.edit', $class) }}" class="p-2 rounded-full group transition-all duration-500 flex item-center">
                                ...
                                <button 
                                    @click="openDeleteModal = true; deleteUrl = '{{ route('jenis.destroy', $class) }}'"
