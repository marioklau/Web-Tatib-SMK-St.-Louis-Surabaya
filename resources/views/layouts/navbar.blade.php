    ...
    <nav class="bg-white shadow-lg z-10">
        <div class="max-w-none mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div id="user-menu-button" class="ml-3 relative hidden md:flex items-center gap-2 cursor-pointer">
                    @php
                        $user = Auth::user();
                    ...
                    <div id="avatar-button" class="h-9 w-9 rounded-full bg-indigo-600 text-white flex items-center justify-center text-lg font-semibold cursor-pointer">
                        {{ $initial }}
                    </div>
