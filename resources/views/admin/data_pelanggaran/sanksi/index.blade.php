...
<div class="container mx-auto" x-data="{ openDeleteModal: false, deleteUrl: '', errorMessage: '' }">
                    ...
                    <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                        ...
                        <td class="p-1 whitespace-nowrap text-center text-xs leading-6 font-medium text-gray-900">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <!-- Tombol Edit -->
                                <a href="{{ route('sanksi.edit', $sanctions) }}" class="p-2 rounded-full group transition-all duration-500 flex item-center">
                                ...
                                <button 
                                    @click="openDeleteModal = true; deleteUrl = '{{ route('sanksi.destroy', $sanctions) }}'"
    ...
    >
        <div class="bg-white rounded-lg p-6 shadow-lg w-96 text-center">
            ...
            <p class="mb-6 text-gray-700">Apakah Anda yakin ingin menghapus sanksi pelanggaran ini?</p>
