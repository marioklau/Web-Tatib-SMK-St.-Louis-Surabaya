...
<div class="container mx-auto "  x-data="{ openDeleteModal: false, deleteUrl: '', errorMessage: '' }">
    ...
    <div class="overflow-hidden">
        <table class="min-w-full rounded-xl">
            ...
            <tbody class="divide-y divide-gray-300">
                @forelse ($jenis as $type)
                    ...
                    <td class="p-1 whitespace-nowrap text-center text-xs leading-6 font-medium text-gray-900">{{ $loop->iteration + ($jenis->currentPage() - 1) * $jenis->perPage() }}</td>
                        <td class="p-1 whitespace-nowrap text-xs leading-6 font-medium text-left text-gray-900">{{ $type->bentuk_pelanggaran }}</td>
                        ...
                        <div class="flex items-center justify-center space-x-2">
                                ...
                                <!-- Tombol Delete (tanpa form) -->
                                <button 
                                    @click="openDeleteModal = true; deleteUrl = '{{ route('jenis.destroy', $type) }}'"
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between p-4 text-sm">
            <div>
                Show <span class="font-bold">{{ $jenis->firstItem() }}</span> to 
                <span class="font-bold">{{ $jenis->lastItem() }}</span> from 
    ...
    >
        <div class="bg-white rounded-lg p-6 shadow-lg w-96 text-center">
            ...
            <p class="mb-6 text-gray-700">Apakah Anda yakin ingin menghapus jenis pelanggaran ini?</p>
