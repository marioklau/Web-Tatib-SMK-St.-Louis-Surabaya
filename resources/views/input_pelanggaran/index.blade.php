                ...
                <tr class="transition-all duration-500 hover:bg-gray-50" data-id="{{ $offense->id }}">
                    ...
                    <td class="p-1 whitespace-nowrap text-xs leading-6 font-medium text-center text-gray-900">
                        <div class="flex items-center justify-center space-x-2">
                            ...
                            <button type="button" @click="$dispatch('open-delete-modal', { url: '{{ route('input_pelanggaran.destroy', $offense->id) }}'})" 
...
>
    <div class="bg-white rounded-lg p-6 shadow-lg w-96 text-center">
        ...
        <p class="mb-6 text-gray-700">Apakah Anda yakin ingin menghapus pelanggaran ini?</p>
