        ...
        <table class="min-w-full rounded-xl">
            <thead>
                <tr class="bg-gray-200">
                    ...
                    <th scope="col" class="p-1 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Sanksi</th>
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                ...
                <tr class="transition-all duration-500 hover:bg-gray-50" data-id="{{ $offense->id }}">
                    ...
                    <td class="p-1 whitespace-nowrap text-xs leading-6 font-medium text-left text-gray-900">
                        {{ $offense->keputusan_tindakan ?? '-' }} <!-- Menampilkan keputusan tindakan yang disimpan -->
                    </td>
...
{{-- The script block below was removed because it's not relevant to this page --}}
{{-- It was likely copied from an input/create form page. --}}
{{-- Keeping JavaScript specific to the page's functionality helps maintain clean code. --}}
