        ...
        <table class="min-w-full rounded-xl">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                ...
                <tr class="transition-all duration-500 hover:bg-gray-50" data-id="{{ $offense->id }}">
                    ...
                    <td class="p-1 whitespace-nowrap text-xs leading-6 font-medium text-left text-gray-900">{{ $offense->sanksi->keputusan_tindakan }}</td>
                    ...
                    <td class="p-1 whitespace-nowrap text-xs leading-6 font-medium text-center text-gray-900">
                        <div class="flex items-center justify-center space-x-2">
                            ...
                            <a href="{{ route('input-pelanggaran.edit', $offense) }}">
                                <button
                                    type="button"
...
>
    ...
    >
        ...
        <form @submit.prevent="
            ...
            fetch(`/input-pelanggaran/${editingOffenseId}/update-status`, {
                method: 'PATCH',
                headers: {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const kategoriData = @json($kategori); // Assuming $kategori is passed from controller

        // This script block is for the main 'input-pelanggaran.create' page
        // It won't run on the 'input-pelanggaran.edit' page if it doesn't have these elements
        // The modal for 'edit status' on this page is handled by Alpine.js in the x-data block.

        if (kategoriSelect && jenisSelect && sanksiSelect) { // Check if elements exist before adding listeners
            kategoriSelect.addEventListener('change', function () {
                ...
                sanksiSelect.value = ''; // Reset sanksi selection
            });
        }
    });
</script>
