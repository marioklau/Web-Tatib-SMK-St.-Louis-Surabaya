        ...
        <table class="min-w-full rounded-xl">
            ...
            <tbody class="divide-y divide-gray-300">
                ...
                <td class=" p-1 whitespace-nowrap text-center text-sm leading-6 font-medium text-gray-900">{{ $loop->iteration }}</td>
                    ...
                    <td class=" p-1 whitespace-nowrap text-sm leading-6 font-medium text-left text-gray-900">{{ $offense->sanksi->nama_sanksi }}</td>
...
<script>
    ...
    function updateStatus() {
        ...
        .then(data => {
            ...
            const statusCell = document.querySelector(`tr[data-id="${offenseId}"] .text-center span`); // assuming you add data-id to your tr
            if (statusCell) {
