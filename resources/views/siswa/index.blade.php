...
<div class="container mx-auto">
    <h1 class="text-3xl font-semibold text-start mb-8">Data Siswa</h1>
        ...
        <table class="w-full table-auto">
            <thead>
                <tr class="bg-gray-300 text-gray-900 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 border text-left">Kelas</th>
                    <th class="py-3 px-6 border text-left">Nama Siswa</th>
                    <th class="py-3 px-6 border text-left">Jenis Kelamin</th>
            ...
            <tbody class="text-gray-900 text-sm font-light">
                @forelse ($siswa as $student)
                    <tr class="border-b border-gray-300 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 border text-left">{{ $student->kelas->nama_kelas }}</td>
                        <td class="py-3 px-6 border text-left">{{ $student->nama_siswa }}</td>
                        <td class="py-3 px-6 border text-left">{{ $student->jenis_kelamin }}</td>
