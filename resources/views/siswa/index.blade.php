...
<div class="container mx-auto" x-data="{ openDeleteModal: false, deleteUrl: '', errorMessage: '' }">
                ...
                @forelse ($siswa as $student)
                    <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                        ...
                        <div class="flex items-center justify-center space-x-2">
                                ...
                                <!-- Tombol Edit -->
                                <a href="{{ route('jenis.edit', $student) }}" class="p-2 rounded-full group transition-all duration-500 flex item-center">
                                ...
                                <button 
                                    @click="openDeleteModal = true; deleteUrl = '{{ route('jenis.destroy', $student) }}'"
    ...
    >
        <div class="bg-white rounded-lg p-6 shadow-lg w-96 text-center">
            ...
            <p class="mb-6 text-gray-700">Apakah Anda yakin ingin menghapus siswa ini?</p>
